package com.yash.collection.production;
...
//	static ProductionFacility pro1=new ProductionFacility(101, "Development", "pune", 1, new String[] {"Ecommerce","Banking"},LocalDate.parse("2022-08-03").plusDays(3));
//	static ProductionFacility pro2=new ProductionFacility(102,  "Maintance", "Hydeabad",15, new String[] {"Ecommerce","Banking","DekstopApllication"},LocalDate.parse("2022-08-04").plusDays(3));
//	static ProductionFacility pro3=new ProductionFacility(103, "Support", "Banglore", 10, new String[] {"Ecommerce","Banking","Telecome","Automobile"},LocalDate.parse("2022-09-02"));
//	static ProductionFacility pro4=new ProductionFacility(104, "DataScince", "Chennai", 5, new String[] {"Ecommerce","Banking"},LocalDate.parse("2022-09-01"));
//	
//	public static void main(String[] args) {
//		
//		ArrayList<ProductionFacility>alp= new ArrayList<>();
//		alp.add(pro1);
//		alp.add(pro2);
//		alp.add(pro3);
//		alp.add(pro4);
//		
	public static void main(String[] args) {
	       ...
	       // pfFacility1
ProductionFacility pd1 = new ProductionFacility(101, "Developement", "wardha", 12, new String[] { "abc", "def", "aaa", "mmm", "nnnnn", "gdttyuio" }, LocalDate.of(2022, 8, 30));
ProductionFacility pd2 = new ProductionFacility(102, "Developement", "yavatmal", 13,new String[] { "pqr", "stu", "etryy", "uytrf" }, LocalDate.of(2022, 8, 29));
ProductionFacility pd3 = new ProductionFacility(103, "Developement", "kanpur", 14, new String[] { "vwx", "yz" },LocalDate.of(2022, 8, 28));
